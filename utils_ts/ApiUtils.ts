export class ApiUtils {
    ...
    apiContext: any; // se declara una propiedad de la clase ApiUtils para almacenar el contexto de la solicitud
    loginPayLoad: string; // se declara una propiedad de la clase ApiUtils para almacenar el cuerpo de la solicitud de login
    

    constructor(apiContext: any, loginPayLoad: string) // se crea un constructor para inicializar la clase ApiUtils y se pasa el contexto de la solicitud como parámetro
    {
    ...
    async creatOrder(orderPayload: string) { // se crea una función asincrónica para generar una orden
